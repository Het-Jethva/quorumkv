...
QuorumKV is an in-progress three-node distributed key-value database built in Go. The first vertical slice boots one observable Node; it does not yet implement a Cluster or consensus.
